    ...
    <div>
      ...
      {reports.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-surface">
          <div className="grid grid-cols-[90px_1fr_110px_90px_70px] gap-4 border-b border-border px-5 py-2.5 font-mono text-[10px] tracking-widest text-muted-foreground uppercase">
            <span>Status</span>
            <span>Title</span>
            <span>Format</span>
            <span>Date</span>
          ...
          {reports.map((report) => (
            <Link
              ...
              className="group grid grid-cols-[90px_1fr_110px_90px_70px] items-center gap-4 border-b border-border px-5 py-3 transition-colors last:border-b-0 hover:bg-surface-2"
            >
